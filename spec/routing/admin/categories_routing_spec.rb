...
RSpec.describe Admin::CategoriesController, type: :routing do
  describe "routing" do
    ...
    it "routes to #index with parent_id" do
      expect(:get => "/admin/categories/1/children").to route_to("admin/categories#index", :parent_id => "1")
    end
    
    it "routes to #new with parent_id" do
      expect(:get => "/admin/categories/1/children/new").to route_to("admin/categories#new", :parent_id => "1")
    end
    
    it "routes to #create with parent_id" do
      expect(:post => "/admin/categories/1/children").to route_to("admin/categories#create", :parent_id => "1")
    end
  end
end
